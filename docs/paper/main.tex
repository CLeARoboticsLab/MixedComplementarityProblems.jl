...
total dimension of the primal, dual, and slack variables $(x, \lamdba, \mu, z)$.
...
We implement two additional subtleties. First, on line \todo{ref}, we conduct a
...
At the end of each inner loop (cf. lines \ref{line refs}), if the solver successfully drove $\|K_\rho\| \le
...
\todo{insert solver algorithm block with label alg:solver}
